...
New-AzAvailabilitySet -ResourceGroupName $resourceGroupName -Name $availabilitySetName -Location $location -PlatformFaultDomainCount 2 -PlatformUpdateDomainCount 2 -Sku Aligned
